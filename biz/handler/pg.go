...
func init() {
	...
	common.Register(constant.CallbackAPIModule, constant.MethodPost, "/game/:currency/call/pg/VerifySession", pgCallbackCommon)

	common.Register(constant.CallbackAPIModule, constant.MethodPost, "/game/call/pg/Cash/Get", pgCallbackCommon)
	common.Register(constant.CallbackAPIModule, constant.MethodPost, "/game/:currency/call/pg/Cash/Get", pgCallbackCommon)

	common.Register(constant.CallbackAPIModule, constant.MethodPost, "/game/call/pg/Cash/TransferInOut", pgCallbackCommon)
	common.Register(constant.CallbackAPIModule, constant.MethodPost, "/game/:currency/call/pg/Cash/TransferInOut", pgCallbackCommon)

	common.Register(constant.CallbackAPIModule, constant.MethodPost, "/game/call/pg/Cash/Adjustment", pgCallbackCommon)
	common.Register(constant.CallbackAPIModule, constant.MethodPost, "/game/:currency/call/pg/Cash/Adjustment", pgCallbackCommon)

	common.Register(constant.CallbackAPIModule, constant.MethodPost, "/game/call/pg/Cash/UpdateBetDetail", pgCashUpdateBetDetail)
	common.Register(constant.CallbackAPIModule, constant.MethodPost, "/game/:currency/call/pg/Cash/UpdateBetDetail", pgCashUpdateBetDetail)

	common.Register(constant.InnerApIModel, constant.MethodPost, "/game/:currency/pg/:path", pgLoginProxy)
...
func pgCallbackCommon(ctx context.Context, c *app.RequestContext) {
	...
	statusCode, tempMap := common.ForwardFormUrl(tenant.TenantCode, tenant.Host+url, params)
...
func pgLoginProxy(ctx context.Context, c *app.RequestContext) {
	currency := c.Param("currency")
	path := c.Param("path")
	var params = make(map[string]string)
	c.PostArgs().VisitAll(func(k, v []byte) {
